...
This site must use the same new bride-side Convex attendance endpoint as the main invitation, so its guest counter remains shared. The server constrains this version to the wedding event only.
